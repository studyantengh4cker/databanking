  ...
  return (
    <div className="p-5 flex flex-col flex-1 gap-4">
      <div className="row flex gap-20 [&_button]:flex-1 [&_button]:bg-[#720000] [&_button]:rounded-xl [&_button]:text-white [&_button]:py-2">
        <Link href={`/student/reviewers/${reviewer_id}/attempts`}className="bg-[#720000] px-5 py-2 rounded-xl text-white hover:bg-[#320000]">Attempt History</Link>
      </div>
      <div className="test-specification-card">
        ...
        <div className="body shadow-md rounded-b-xl bg-white flex flex-col flex-1 items-start p-5 min-h-full gap-10">
          ...
          <Link className="bg-[#720000] px-5 py-2 rounded-xl text-white hover:bg-[#320000]" href={`/student/reviewers/${reviewer_id}/attempt`}>
            Take Test
          </Link>
        </div>
      </div>
